        ...
        },
        {
          ...
          "function": {
            ...
            "parameters": [
              {
                "ParamType": 5,
                "value": "set udg_TempInt = GetTerrainCliffLevel(GetLocationX(udg_TempPoint), GetLocationY(udg_TempPoint))"
              }
            ],
          ...
          "Then": [
            {
              ...
              "function": {
                ...
                "parameters": [
                  {
                    "ParamType": 5,
                    "value": "call SetUnitX(udg_SR_Slided_Unit[udg_SR_Loop] , GetLocationX(udg_SR_Target_Point))"
                  }
                ],
                "value": "CustomScriptCode"
              }
            },
            {
              ...
              "function": {
                ...
                "parameters": [
                  {
                    "ParamType": 5,
                    "value": "call SetUnitY(udg_SR_Slided_Unit[udg_SR_Loop] , GetLocationY(udg_SR_Target_Point))"
                  }
                ],
                "value": "CustomScriptCode"
              }
        ...
        },
        {
          ...
          "function": {
            ...
            "parameters": [
              {
                "ParamType": 5,
                "value": "call RemoveLocation(udg_SR_Caster_Point)"
              }
            ],
            "value": "CustomScriptCode"
          }
